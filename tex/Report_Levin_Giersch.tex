...
\keywords{Paleoclimate, Data harmonisation, Paleoclimate datasets, Temperature comparison, TraCE-21k, CHELSA-TraCE21k-centennial, PalMod2, Beyer2020}
...
\section{The data}
Four archives were selected to span the trade-off between temporal resolution, spatial resolution and time coverage. Two are raw transient GCM simulations (TraCE-21k, PalMod2); two are high-resolution, observation-anchored products (Beyer2020/2021, CHELSA-TraCE21k). Table~\ref{tab:overview} summarises them. All are downloaded via the \tabbr{data\_downloader} notebook; the total download is on the order of 1\,TB, dominated by the $\sim$1\,km CHELSA GeoTIFFs.
