...
Two of the four archives cannot be used as delivered. The \tabbr{data\_processor} notebook performs the necessary conversions; TraCE-21k and Beyer2020 are already analysis-ready NetCDF and are passed through unchanged.
