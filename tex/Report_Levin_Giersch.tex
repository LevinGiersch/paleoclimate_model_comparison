...
The difference maps are computed on the shared $96\times48 = 4608$-cell TraCE-21k grid described in Section~\ref{sec:caveats}.
...
\paragraph{Air temperature, all six pairs.} The four air archives yield six pairwise comparisons (Fig.~\ref{fig:diff_air}), each averaged over the shared window noted in the panel. The maps show that Beyer2020 is generally warmer than PalMod2 across the tropics, mid-latitudes and mountain ranges but markedly colder over the high-northern continents (Fig.~\ref{fig:diff_air}a); Beyer2020 is warmer than TraCE-21k almost everywhere, most strongly over northern Eurasia (Fig.~\ref{fig:diff_air}b); Beyer2020 and CHELSA-TraCE21k-centennial, the two observation-anchored products, are the most similar pair, with only faint differences, excpt for high northern altitudes where CHELSA-TraCE21k-centennial is warmer in most cells (Fig.~\ref{fig:diff_air}c); the two GCMs differ strongly and coherently, PalMod2 is much warmer than TraCE-21k at high northern latitudes and cooler over the Southern Ocean margin and in mountain ranges (Fig.~\ref{fig:diff_air}d); PalMod2 $-$ CHELSA-TraCE21k-centennial is moderate and patchy (Fig.~\ref{fig:diff_air}e); and TraCE-21k is colder than CHELSA-TraCE21k-centennial across most land, again strongest in the high north (Fig.~\ref{fig:diff_air}f).
...
\vspace{3pt}
\begin{subfigure}{0.49\textwidth}\centering\includegraphics[width=\linewidth]{diff_air_beyer2020_chelsatrace21k.png}\caption{Beyer2020 $-$ CHELSA-TraCE21k-centennial (0--22\,ka).}\end{subfigure}\hfill
...
\vspace{3pt}
\begin{subfigure}{0.49\textwidth}\centering\includegraphics[width=\linewidth]{diff_air_palmod2_chelsatrace21k.png}\caption{PalMod2 $-$ CHELSA-TraCE21k-centennial (0--22\,ka).}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\centering\includegraphics[width=\linewidth]{diff_air_trace21k_chelsatrace21k.png}\caption{TraCE-21k $-$ CHELSA-TraCE21k-centennial (0--22\,ka).}\end{subfigure}
\caption{Mean air-temperature differences for all six pairs of the four archives (green $=$ first archive warmer, purple $=$ colder), sampled at the TraCE-21k grid and averaged over each pair's shared time window.}
\label{fig:diff_air}
\end{figure*}
